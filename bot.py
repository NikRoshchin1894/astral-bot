...
def generate_natal_chart_with_gpt(birth_data, api_key):
    ...
    try:
        ...
        section_specs = {
            ...
            3: "- Раздел 3 (не менее 6 000 символов): Структура: сначала подзаголовок 'Сильные стороны', затем опиши сильные стороны (как они проявляются, как можно их усилить; упомяни планеты, дома, аспекты); затем подзаголовок 'Слабые стороны', затем опиши слабые стороны (как они проявляются, как можно их исправить; упомяни планеты, дома, аспекты)",
