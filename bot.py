...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    welcome_message = '''Привет. Я — Айла, твой личный проводник в астрологии. Я опираюсь на точные астрономические данные: учитываю момент твоего рождения, географию, время, чтобы создать глубокий и персональный анализ.



Мои возможности:

🪐 Натальная карта — индивидуальный разбор, раскрывающий структуру личности, потенциалы и направления развития.

💞 Синастрия — анализ совместимости двух людей: динамика отношений, точки притяжения, зоны напряжения и перспективы союза.
...
def generate_natal_chart_with_gpt(birth_data, api_key):
    ...
    try:
        ...
        section_specs = {
            ...
            3: "- Раздел 3 (не менее 6 000 символов): Обязательно пропиши подзаголовки 'Сильные стороны' и 'Слабые стороны' с дальнейшим перечислением. Под 'Сильными сторонами' опиши как они проявляются, как можно их усилить; упомяни планеты, дома, аспекты. Под 'Слабыми сторонами' опиши как они проявляются, как можно их исправить; упомяни планеты, дома, аспекты",
